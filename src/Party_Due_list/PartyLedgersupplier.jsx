...
<h1 className='fw-bold' style={{fontSize:"20px"}}>Supplier Ledger Details</h1>
...
<Link to={'/partyledger'} className='w-36  pl-3 pt-2 font-semibold  h-9 text-white rounded-t-md bg-purple-700' style={{border:"1px solid purple",borderTop:"none",borderRight:"none",borderLeft:"none"}}>Buyer</Link>
<Link  className='w-64 h-9 text-md text-black  pt-2 pl-3' style={{border:"1px solid purple",borderTop:"none",borderRight:"none",borderLeft:"none"}}>Supplier </Link>
...
export default PartyledgerSupplier